...
use windows::Win32::UI::WindowsAndMessaging::{
    GetClientRect, GetWindowRect, SetWindowPos, PostMessageW,
    WM_LBUTTONDOWN, WM_LBUTTONUP, SWP_NOZORDER, SWP_NOMOVE, SWP_FRAMECHANGED
};
use windows::Win32::Graphics::Gdi::ClientToScreen;

use crate::config::state::{AppState, DeviceInfo, CachedTemplate};
...
#[tauri::command]
pub async fn test_template(state: State<'_, AppState>, name: String) -> std::result::Result<String, String> {
    ...
    unsafe {
        ...
        let threshold = if name.starts_with("seeds/") || name.contains("_strict") { 12 } else { 25 };
